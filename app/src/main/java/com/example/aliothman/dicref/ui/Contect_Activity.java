...
public class Contect_Activity extends AppCompatActivity {
    TextView textData ;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_contect_);
        textData = findViewById(R.id.infoData);
        getData();
    }
    ...
    private void getData() {
        ...
        AndroidNetworking.post(Static_Content_Url)
                ...
                .addBodyParameter("content_slug" ,"contact-us")
                ...
                .getAsString(new StringRequestListener() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (item.length()==0){
                                AppUtils.showInfoToast(Contect_Activity.this ,getString(R.string.no_data));
                            }
                            ...
                            e.printStackTrace();
                            AppUtils.showInfoToast(Contect_Activity.this,getString(R.string.error));
                        }
                    }
                    @Override
